...
export default function Navebar({ menuhide, setMenuhide, cart, setCart }) {
  ...
  useEffect(() => {
    ...
    // Cleanup function to remove the class when the component unmounts or modalIsOpen changes
    return () => {
      document.body.classList.remove("modal-open");
    };
  }, [modalIsOpen]);
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="nave_container">
            ...
            <div className="user_cart">
              <i className="small_search" onClick={handleShowSearch}>
                {" "}
                <IoSearchSharp />
              </i>
              <i onClick={() => setIsOpen(true)} style={{ fontSize: "17.5px" }}>
                {" "}
                <FaRegUser />{" "}
              </i>
      ...
      <div className={`drop_search ${showSearch ? "true" : "false"}`}>
        <div className="cont">
          <i className="close_i_" onClick={handleShowSearch}>
            {" "}
            <IoMdClose />{" "}
          </i>
          <div className="search">
